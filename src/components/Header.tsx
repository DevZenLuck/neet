import { Settings, Moon, Sun, Bookmark, AlertCircle } from 'lucide-react';
...
export function Header({ onFilterClick, onBookmarksClick, onIncorrectClick, theme, onToggleTheme, activeFilters, bookmarkCount, incorrectCount }: HeaderProps) {
  return (
